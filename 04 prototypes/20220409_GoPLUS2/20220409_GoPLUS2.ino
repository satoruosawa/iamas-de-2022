...
void Port_B() {
  ...
  int hub2 = goPlus.hub1_a_read_value(HUB2_R_ADDR);
  M5.Lcd.printf("HUB1 Analog: %d \r\n", hub2);
  int hub3 = goPlus.hub1_a_read_value(HUB3_R_ADDR);
  M5.Lcd.printf("HUB1 Analog: %d \r\n", hub3);
  // if (abs(hub1 - _hub1) > 3) {
...
void setup() {
  ...
  //   digital_input goPlus.hub2_set_io(HUB2_R_O_ADDR, 1); //set digital_output
  //   to digital_input goPlus.hub3_set_io(HUB3_R_O_ADDR, 1); //set
  //   digital_output to digital_input
