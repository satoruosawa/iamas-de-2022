// Remove the M5GO base when using this example, otherwise it will not work
// properly,PDM Unit connected PORT-A
...
static void i2sMicroFFTtask(void *arg) {
  ...
  // Serial.println(FFTValueBuff[0]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[1]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[2]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[3]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[4]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[5]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[6]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[7]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[8]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[9]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[10]);
  // Serial.print(",");
  // Serial.println(FFTDataBuff[0]);
}
...
void MicroPhoneFFT() {
  ...
  // Serial.print(FFTValueBuff[10]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[11]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[12]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[13]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[14]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[15]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[16]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[17]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[18]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[19]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[20]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[21]);
  // Serial.print(",");
  // Serial.print(FFTValueBuff[22]);
  // Serial.print(",");
  // Serial.println(FFTValueBuff[23]);
}
